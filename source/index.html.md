...
backend | false | all | Select the backend you want to enable. By default all backends are enabled. Valid values are: clarifai, imagga, googlevision, rekognition, llava, bakllava, jinaai and openai.
